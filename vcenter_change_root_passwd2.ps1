...
$passwd_current = read-host "Current password" -AsSecureString
write-host "new passwd"
$passwd_new1 = read-host "New password" -AsSecureString
$passwd_new =  [System.Runtime.InteropServices.Marshal]::PtrToStringUni(([System.Runtime.InteropServices.Marshal]::SecureStringToCoTaskMemUnicode($passwd_new1)))
...
#	$Cred = New-Object System.Management.Automation.PsCredential("root",$password)
	$Cred = New-Object System.Management.Automation.PsCredential("root",$passwd_current)
